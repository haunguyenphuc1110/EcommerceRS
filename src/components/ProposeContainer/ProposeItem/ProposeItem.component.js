...
const ProposeItem = (props) => {
  ...
  return (
    <TouchableOpacity style={styles.main} onPress={() => onNavigateToDetails(item, capitalizeFirstLetter(item.product_name))}>
      <Image source={item.uri ? { uri: item.uri } : IMAGES.PRODUCT} style={styles.image} resizeMode={"cover"}/>
